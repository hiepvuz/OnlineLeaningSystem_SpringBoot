...
```
cd existing_repo
git remote add origin https://gitlab.com/fu-fall22-kltn/swp490_g7.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/fu-fall22-kltn/swp490_g7/-/settings/integrations)
